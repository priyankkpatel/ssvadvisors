...
const defaultReviews = [
  {
    ...
    rating: 5,
    text: "Tirth Patel made our business GST registration and annual ITR filing incredibly simple. The obstacles we faced with documentation were resolved quickly under his guidance. He explains everything in Gujarati and English, making him highly trustworthy.",
  },
  {
    name: 'Anjali Sharma',
    role: 'Homeowner',
    ...
    rating: 5,
    text: "We bought our first flat through Shree Siddhivinayak. Tirthbhai helped us verify the property title documents, negotiate transparently, and even got our home loan approved within 10 days! Highly recommended for their professional approach.",
  },
  {
    name: 'Hardik Shah',
    role: 'Director, Shah Logistics',
    location: 'Nikol, Ahmedabad',
    rating: 5,
    text: "Outstanding tax consultant in Ahmedabad. They manage our corporate accounting, payroll bookkeeping, and MSME filings perfectly. Their transparent fee structure and regular WhatsApp compliance updates keep us worry-free.",
  },
  {
    name: 'Suresh Mewada',
    role: 'Shop Owner',
    ...
    rating: 5,
    text: "Securing a commercial shop lease can be tedious. Tirth and his team checked the registry titles, drafted a watertight rental agreement, and got us set up in Abhishek Complex. Fair dealing and great local real estate knowledge.",
  },
];
